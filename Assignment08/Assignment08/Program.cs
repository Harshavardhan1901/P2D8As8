...
namespace Assignment08
{
    internal class Program
    {
        ...
        static void InsertEmployee(AdvancedDBEntities db)
        {
            try
            {
        ...
        static void UpdateEmployee(AdvancedDBEntities db)
        {
            try
            {
                ...
                else
                {
                    ...
                    Console.WriteLine("Enter Employee Salary ");
                    emps.Salary = double.Parse(Console.ReadLine());
                    Console.WriteLine("Enter Employee Date of Birth ");
        ...
        static void DisplayEmployeeDetails(AdvancedDBEntities db)
        {
            try
            {
        ...
        static void InsertProduct(AdvancedDBEntities db)
        {
            try
            {
        ...
        static void UpdateProduct(AdvancedDBEntities db)
        {
            try
            {
                Console.WriteLine("Enter ID to update details");
                ...
                else
                {
                    ...
                    Console.WriteLine("Enter Product Price ");
                    prds.Price = double.Parse(Console.ReadLine());
                    Console.WriteLine("Enter Product Release Date ");
        ...
        static void DisplayProductDetails(AdvancedDBEntities db)
        {
            try
            {
        ...
        static void InsertOrder(AdvancedDBEntities db)
        {
            try
            {
                Order ord = new Order();
        ...
        static void UpdateOrder(AdvancedDBEntities db)
        {
            try
            {
                Console.WriteLine("Enter ID to update details");
        ...
        static void DisplayOrderDetails(AdvancedDBEntities db)
        {
            try
            {
